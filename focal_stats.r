...
road2splag1 <- function(roadgrid.i) {
  ...
  # stack mean + sum raster  +count pixel raster
...
names(watsplag1) <- c("Mean3x3splag1_water","Sum3x3splag1_water","Cnt3x3splag1_water")
x <- stack(x, watsplag1)

# add spatial lag 2
watsplag2 <- road2splag2(ghswat)
names(watsplag2) <- c("Mean5x5splag2_water","Sum5x5splag2_water","Cnt5x5splag2_water")
x <- stack(x,watsplag2)
names(x)
...
names(landsplag1) <- c("Mean3x3splag1_land","Sum3x3splag1_land","Cnt3x3splag1_land")
x <- stack(x, landsplag1)

# add spatial lag 2
landsplag2 <- road2splag2(ctr_land)
names(landsplag2) <- c("Mean5x5splag2_land","Sum5x5splag2_land","Cnt5x5splag2_land")
...
names(seasplag1) <- c("Mean3x3splag1_sea","Sum3x3splag1_sea","Cnt3x3splag1_sea")
x <- stack(x, seasplag1)

# add spatial lag 2
seasplag2 <- road2splag2(ctr_sea)
names(seasplag2) <- c("Mean5x5splag2_sea","Sum5x5splag2_sea","Cnt5x5splag2_sea")
x <- stack(x,seasplag2)
names(x)
